  ...
  */
    constructor(initcarId, initweigth, initpower, inittank, initseats) {
        ...
        this.setColor=(newColor)=>{
            ...
            {
                throw new Error ('La couleur sélectionnée est indisponible !');
            }
    ...
    repeindre(newColor){
        try{
            ...
            alert(e);
            this.repeindre(prompt('Choisissez à présent la couleur de votre véhicule.\n\
        Gamme disponible : Bleue - Rouge - Blanche - Jaune - Noire - Verte - Grise').toLowerCase());
        }
        /*
        Test d'utilisation de méthode récursive.
        En cas d'erreur, la méthode s'appelle elle même en demandant une nouvelle valeur.
        */
